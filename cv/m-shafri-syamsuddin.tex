...
\href{https://github.com/niseruu}{github.com/niseruu} &
\href{https://shafri.pages.dev}{shafri.pages.dev}\\
\end{tabularx}
...
\textbf{Assistant Lecturer} \hfill Sep 2019 -- Sep 2020\\
Universitas Islam Indonesia, Yogyakarta, ID
\begin{itemize}
  \item Held an assistant lecturer role alongside undergraduate study at Universitas Islam Indonesia.
\end{itemize}

\section*{Selected Projects}
\textbf{AssistX Suite Platform Engineering} \hfill 2026 -- Present
\begin{itemize}
  \item Public-safe case study of retrieval-augmented generation, document intelligence, customer-intelligence workflows, and delivery tooling at AssistX Enterprise; implementation details remain confidential.
\end{itemize}
...
Double Degree Programme, Information Engineering (GPA 3.68/4.00)\\
