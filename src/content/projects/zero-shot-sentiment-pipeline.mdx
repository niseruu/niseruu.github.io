...
eyebrow: "AI Engineering · NLP Analytics"
...
metrics:
  - value: "0"
    label: "Fine-tuning runs required to change the candidate label set"
  - value: "3"
    label: "Dashboard-ready outputs: trends, label share, and confidence diagnostics"
links:
  - label: "View GitHub"
