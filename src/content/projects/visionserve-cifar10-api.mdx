...
contextLabel: "PRODUCTION-PATTERN DEMONSTRATION"
summary: "A production-pattern demonstration: Dockerised FastAPI model serving with reproducible training, artifact tracking, and class probabilities with confidence scores."
